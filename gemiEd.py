...
class UltimateSocketMatcher:
    def __init__(self):
        ...
        # self.r_idx = None
        # self.c_idx = None
        self.K = np.array([[2674.7629874104787,0.,1279.5],
        ...
        self.dist = np.array([-0.11744968686298927,0.27089153364253454,0.0012180578884344092,0.00067320963008635703,-0.078845410108757258])
