...
if __name__ == '__main__':
    ...
    img_files = sorted([f for f in os.listdir(data_dir) if f.endswith('.jpg') and f != 'temp'])
    ...
    for img_file in img_files:
        ...
        detector = pyced.CED(np.ascontiguousarray(rect))
        # detector.remain_score = 0.8
        detector.run_CED()
        ...
        wh = br-tl
        keypoints-=tl
        final_pts,status,centers = matcher.solve(ellipses_,[tl[0],tl[1],wh[0],wh[1]],keypoints=keypoints)
