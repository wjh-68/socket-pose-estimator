#!/usr/bin/env python3
"""
Online pose evaluation: compares camera-based PnP/BA pose with robot pose.
- Captures images from camera (VideoCapture)
- Gets robot TCP pose via pyaubo_sdk
- Computes camera pose via IPPE + BA
- Compares with robot-derived pose
"""
import os
import cv2
import numpy as np
...
def main():
    ...
    print(f"\n{'Frame':<6} {'method':<6} {'t_x':>10} {'t_y':>10} {'t_z':>10} "
          f"{'r_x':>10} {'r_y':>10} {'r_z':>10} {'reproj_err':>10}")
    print("-" * 90)
